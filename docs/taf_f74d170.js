...
Taf.JceOutputStream.prototype.writeString = function(t, e) {
    ...
    r.length > 255 ? (this.writeTo(t, Taf.DataHelp.EN_STRING4), this.buf.writeUInt32(r.length)) : (this.writeTo(t, Taf.DataHelp.EN_STRING1), this.buf.writeUInt8(r.length)),
...
Taf.JceOutputStream.prototype.writeMap = function(t, e) {
    ...
    for (var r in e.value) e.kproto._write(this, 0, r),
...
Taf.Wup.prototype.writeBoolean = function(t, e) {
    ...
    if (r.writeBoolean(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
...
Taf.Wup.prototype.writeInt8 = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeInt8(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
        a = TAF.TypeHelp.CHAR;
        if (void 0 == i) {
...
Taf.Wup.prototype.writeInt16 = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeInt16(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
...
Taf.Wup.prototype.writeInt32 = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeInt32(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
...
Taf.Wup.prototype.writeInt64 = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeInt64(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
...
Taf.Wup.prototype.writeFloat = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeFloat(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
...
Taf.Wup.prototype.writeDouble = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeDouble(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
...
Taf.Wup.prototype.writeString = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeString(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
...
Taf.Wup.prototype.writeVector = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeVector(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBinBuffer()));
    else {
        var i = this.data.get(t),
        a = e._className();
        if (void 0 == i) {
...
Taf.Wup.prototype.writeStruct = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeStruct(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
        a = " ";
        if (void 0 == i) {
...
Taf.Wup.prototype.writeBytes = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeBytes(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
        a = "vec";
        if (void 0 == i) {
...
Taf.Wup.prototype.writeMap = function(t, e) {
    var r = new Taf.JceOutputStream;
    if (r.writeMap(0, e), 3 == this.iVersion) this.newdata.put(t, new Taf.BinBuffer(r.getBuffer()));
    else {
        var i = this.data.get(t),
...
function TafHandler() {
    function e() {
        ...
        G.ISDEBUG && (e = "ws://183.60.218.225:16258"),
        s.info("%cconnecting " + e, c("#0000E3")),
        f = new WebSocket(e),
        f.onopen = n,
        f.onclose = a,
        f.onerror = r,
    ...
    function n() {
        ...
        p = 0,
        u.connected = !0,
        u.dispatch("WEBSOCKET_CONNECTED")
    }
    function a(t) {
        u.connected = !1,
        s.warn("%c=== WebSocket Closed ===", "font-size:120%", t),
        10 > p ? (p++, s.warn("%c=== WebSocket é‡è¿ž" + p + "... ===", "font-size:120%"), setTimeout(e, 1e3)) : s.warn("%c=== WebSocketé‡è¿žæ¬¡æ•°è¶…æ ‡ ===", "font-size:120%")
    }
    function r(e) {
        s.warn("%c=== WebSocket Error ===", "font-size:120%", e)
    }
    function o(e) {
        var t = new FileReader;
        t.onload = function() {
            var e = this.result,
            t = new Taf.JceInputStream(e),
            n = new HUYA.WebSocketCommand;
            switch (n.readFrom(t), n.iCmdType) {
            case HUYA.EWebSocketCommandType.EWSCmd_RegisterRsp:
                t = new Taf.JceInputStream(n.vData.buffer);
                var a = new HUYA.WSRegisterRsp;
                a.readFrom(t),
                s.log("%c<<<<<<< %crspRegister", c("#0000E3"), c("#D9006C"), a),
                u.dispatch("WSRegisterRsp", a);
                break;
            case HUYA.EWebSocketCommandType.EWSCmd_WupRsp:
                var r = new Taf.Wup;
                r.decode(n.vData.buffer);
                var o = TafMx.WupMapping[r.sFuncName];
                if (o) {
                    o = new o;
                    var i = r.newdata.get("tRsp") ? "tRsp": "tResp";
                    r.readStruct(i, o, TafMx.WupMapping[r.sFuncName]),
                    s.log("%c<<<<<<< %crspWup:%c " + r.sFuncName, c("#0000E3"), c("black"), c("#0000E3"), o),
                    u.dispatch(r.sFuncName, o)
                } else u.dispatch(r.sFuncName);
                break;
            case HUYA.EWebSocketCommandType.EWSCmdS2C_MsgPushReq:
                t = new Taf.JceInputStream(n.vData.buffer);
                var f = new HUYA.WSPushMessage;
                f.readFrom(t),
                t = new Taf.JceInputStream(f.sMsg.buffer);
                var p = TafMx.UriMapping[f.iUri];
                p && (p = new p, p.readFrom(t), s.log("%c<<<<<<< %crspMsgPush, %ciUri=" + f.iUri, c("#0000E3"), c("black"), c("#8600FF"), p), u.dispatch(f.iUri, p));
                break;
            case HUYA.EWebSocketCommandType.EWSCmdS2C_HeartBeatAck:
                s.log("%c<<<<<<< rspHeartBeat: " + (new Date).getTime(), c("#0000E3"));
                break;
            case HUYA.EWebSocketCommandType.EWSCmdS2C_VerifyCookieRsp:
                t = new Taf.JceInputStream(n.vData.buffer);
                var d = new HUYA.WSVerifyCookieRsp;
                d.readFrom(t);
                var m = 0 == d.iValidate;
                s.log("%c<<<<<<< %cVerifyCookie", c("#0000E3"), c("#D9006C"), "æ ¡éªŒ" + (m ? "é€šè¿‡ï¼": "å¤±è´¥ï¼"), d);
                break;
            default:
                s.warn("%c<<<<<<< Not matched CmdType: " + n.iCmdType, c("#red"))
            }
        },
    ...
    var i = !1;
    location.href.indexOf("websocketLog") > -1 && (i = !0);
    var s = {
        info: function() {
            return i ? console.info.apply(null, arguments) : void 0
        },
        log: function() {
            return i ? console.log.apply(null, arguments) : void 0
        },
        warn: function() {
            return i ? console.warn.apply(null, arguments) : void 0
        }
    };
    this.connected = !1;
    var f, u = this,
    p = 0;
    e(),
    this.sendWup = function(e, n, a) {
        var r = new Taf.Wup;
        r.setServant(e),
        r.setFunc(n),
        r.writeStruct("tReq", a);
        var o = new HUYA.WebSocketCommand;
        o.iCmdType = HUYA.EWebSocketCommandType.EWSCmd_WupReq,
        o.vData = r.encode();
        var i = new Taf.JceOutputStream;
        o.writeTo(i),
        t(i.getBuffer()),
        s.log("%c>>>>>>> %creqWup: %c" + n, c("#009100"), c("black"), c("#009100"), a)
    },
    this.sendRegister = function(e) {
        var n = new Taf.JceOutputStream;
        e.writeTo(n);
        var a = new HUYA.WebSocketCommand;
        a.iCmdType = HUYA.EWebSocketCommandType.EWSCmd_RegisterReq,
        a.vData = n.getBinBuffer(),
        n = new Taf.JceOutputStream,
        a.writeTo(n),
        t(n.getBuffer()),
        s.log("%c>>>>>>> %creqRegister:", c("#009100"), c("#D26900"), e)
    };
    var d = {};
    this.addListener = function(e, t) {
        return "undefined" == typeof d[e] && (d[e] = []),
        "function" == typeof t && d[e].push(t),
        this
    },
    this.dispatch = function(e, t) {
        ...
        if (n instanceof Array) {
            for (var a = 0,
            r = n.length; r > a; a += 1)"function" == typeof n[a] && n[a](t);
            0 == n.length
        }
        return this
    },
    this.removeListener = function(e, t) {
        var n = d[e];
        if ("string" == typeof e && n instanceof Array) if ("function" == typeof t) {
            for (var a = 0,
            r = n.length; r > a; a += 1) if (n[a].fn === t) {
                d[e].splice(a, 1);
                break
            }
        } else delete d[e];
